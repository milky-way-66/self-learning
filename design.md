...
You can hold more than one. Right now that means **relocate** (a global product company in Hanoi or Ho Chi Minh City, working in English), **learn English**, and **learn DevOps**. Python/FastAPI review and system design of one system are preparation for that job, not extra goals. Keep the list small and named. A pile of themes is not a set of goals.
