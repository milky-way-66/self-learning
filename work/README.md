...
Current goals (the global product-company job, English, DevOps) use the same three kinds. The goal changes the material, not the shape. Dropped goals may still have evidence under `work/<slug>/`.
...
Examples: `devops/notes/2026-09-24-handbook-chapter.md`, `english/essays/2026-09-24-document-tool.md`, `relocate/notes/2026-09-24-what-i-have.md`
